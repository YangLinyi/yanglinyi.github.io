...
**My long-term goal is to leverage the generalization capabilities of large models to empower downstream scenarios**. For now, I am interested in the following three fundamental challenges and three application fields.
